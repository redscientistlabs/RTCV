namespace RTCV.UI
{
    ...
    public partial class VmdLimiterProfilerForm : ComponentForm, IAutoColorize, IBlockable
    {
        ...
        private bool GenerateVMD(bool AutoGenerate = false)
        {
            ...
            var legalAdresses = LocalNetCoreRouter.QueryRoute<long[]>(NetCore.Commands.Basic.CorruptCore, NetCore.Commands.Remote.REMOTE_LONGARRAY_FILTERDOMAIN, new object[] { mi.Name, LimiterListHash, cbLoadBeforeGenerate.Checked ? sk : null });
