namespace RTCV.UI
{
    ...
    public partial class OldSanitizeToolForm : Modular.ColorizedForm
    {
        private BlastLayer _originalBlastLayer = null;

        public OldSanitizeToolForm()
        {
            try
            {
                InitializeComponent();
        ...
        {
            S.GET<OldSanitizeToolForm>().Close();
            var stf = new OldSanitizeToolForm();
            S.SET(stf);
