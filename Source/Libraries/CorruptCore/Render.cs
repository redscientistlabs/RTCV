    ...
    public static class Render
    {
        ...
        public static bool IsRendering
        {
            ...
            set
            {
                ...
                LocalNetCoreRouter.Route(NetCore.Commands.Basic.UI, NetCore.Commands.Remote.RenderDisplay);
            }
        }
        ...
        public static bool StartRender()
        {
            ...
            if (vanguardSupportsRendering)
                LocalNetCoreRouter.Route(NetCore.Commands.Basic.Vanguard, NetCore.Commands.Remote.RenderStart, true);
            else
                Renderer.StopRender();
        ...
        public static void StopRender()
        {
            ...
            if (vanguardSupportsRendering)
                LocalNetCoreRouter.Route(NetCore.Commands.Basic.Vanguard, NetCore.Commands.Remote.RenderStop, true);
        }
