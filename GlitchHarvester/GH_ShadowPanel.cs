...
{
    public partial class GH_ShadowPanel : Form
    {
        public static GH_CanvasForm parentForm;
        ...
        public void UpdateSubForm()
        {
            ...
            if(subForm is SubForms.ISubForm)
                    btnCancel.Visible = (subForm as SubForms.ISubForm).HasCancelButton;
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (subForm is SubForms.ISubForm)
                (subForm as SubForms.ISubForm).SubForm_Ok();
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            if (subForm is SubForms.ISubForm)
                (subForm as SubForms.ISubForm).SubForm_Cancel();
